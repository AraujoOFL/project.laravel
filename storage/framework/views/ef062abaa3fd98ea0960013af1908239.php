...
<div class="card">
    <div class="card-header">
        <h4><i class="bi bi-plus-circle"></i> Novo Fornecedor</h4>
    </div>
    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control <?php $__errorArgs = ['endereco'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                          id="endereco" name="endereco" rows="2" required><?php echo e(old('endereco')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(route('fornecedores.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project.laravel\project.laravel\resources\views/fornecedores/create.blade.php ENDPATH**/ ?>