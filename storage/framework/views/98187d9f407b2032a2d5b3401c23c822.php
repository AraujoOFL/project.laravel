...
unset($__errorArgs, $__bag); ?>" 
                          id="descricao" name="descricao" rows="3"><?php echo e(old('descricao')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control <?php $__errorArgs = ['quantidade_estoque'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                           id="quantidade_estoque" name="quantidade_estoque" value="<?php echo e(old('quantidade_estoque')); ?>" required>
                    <?php $__errorArgs = ['quantidade_estoque'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <select class="form-control <?php $__errorArgs = ['fornecedor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <?php $__currentLoopData = $fornecedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fornecedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($fornecedor->id); ?>" <?php echo e(old('fornecedor_id') == $fornecedor->id ? 'selected' : ''); ?>>
                            <?php echo e($fornecedor->nome); ?> - <?php echo e($fornecedor->cnpj); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(route('produtos.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project.laravel\project.laravel\resources\views/produtos/create.blade.php ENDPATH**/ ?>